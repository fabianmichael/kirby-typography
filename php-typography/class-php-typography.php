...
class PHP_Typography {
	 ...
	 */
	protected $text_parser;

	/**
	 * A DOM-based HTML5 parser.
	 */
	protected $html5_parser;
	 ...
	 */
	protected $heading_tags = array( 'h1' => true, 'h2' => true, 'h3' => true, 'h4' => true, 'h5' => true, 'h6' => true );
	 ...
	 */
	protected $str_functions = array( 'UTF-8' => array(),
									'ASCII' => array(),
									false   => array(),
	);
	 ...
	 */
	protected function update_smart_quotes_brackets() {
	 ...
	 */
	public function initialize_patterns() {
	 ...
	 */
	protected function update_diacritics_replacement_arrays() {
		$patterns = array();
		$replacements = array();
	 ...
	 * @param array $matches
	 */
	protected function _smart_math_callback( array $matches ) {
	 ...
	 * @return string
	 */
	protected function _dewidow_callback( array $widow ) {
